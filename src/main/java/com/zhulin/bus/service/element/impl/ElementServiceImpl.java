...
@ClassRolePermission(group = "supportFile", name = "审核要素管理", value = "element:f", menuValue = "/admin/element")
@Service
public class ElementServiceImpl implements ElementServiceI{
    ...
    @MethodRolePermission(group = "supportFile", name = "审核要素查看", value = "element:fr", groupName = "审核要素管理组")
    @Override
    public List<Element> appReadList(Element element) {
        return elementMapper.selectList(element);
    }

    @MethodRolePermission(group = "supportFile", name = "审核要素详细", value = "element:fd", groupName = "审核要素管理组")
    @Override
    public Element appReadDetail(String id) {
        return elementMapper.selectDetail(id);
    }

    @MethodRolePermission(group = "supportFile", name = "审核要素编辑", value = "element:fe", groupName = "审核要素管理组")
    @Transactional
    @Override
    ...
    @MethodRolePermission(group = "supportFile", name = "审核要素删除", value = "element:fd", groupName = "审核要素管理组")
    @Transactional
    @Override
    ...
    @MethodRolePermission(group = "supportFile", name = "审核要素添加", value = "element:fc", groupName = "审核要素管理组")
    @Transactional
    @Override
