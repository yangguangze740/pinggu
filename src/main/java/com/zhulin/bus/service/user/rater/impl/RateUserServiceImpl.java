...
@ClassRolePermission(group = "frontUser", name = "评审用户管理角色", value = "raterUser:m", menuValue = "/admin/user/rater")
@Service
public class RateUserServiceImpl implements RateUserServiceI{
    @Autowired
    private RateUserMapper rateUserMapper;

    @MethodRolePermission(group = "frontUser", name = "评审用户查看", value = "raterUser:mr", groupName = "评审用户组")
    @Override
    public List<RateUser> appReadList(RateUser rateUser) {
        return rateUserMapper.selectList(rateUser);
    }

    @MethodRolePermission(group = "frontUser", name = "评审用户详细", value = "raterUser:md", groupName = "评审用户组")
    @Override
    public RateUser appReadDetail(String id) {
        return rateUserMapper.selectDetail(id);
    }

    @MethodRolePermission(group = "frontUser", name = "评审用户编辑", value = "raterUser:me", groupName = "评审用户组")
    @Transactional
    @Override
    ...
    @MethodRolePermission(group = "frontUser", name = "评审用户删除", value = "raterUser:md", groupName = "普通用户组")
    @Transactional
    @Override
    ...
    @MethodRolePermission(group = "frontUser", name = "评审用户添加", value = "raterUser:mc", groupName = "普通用户组")
    @Transactional
    @Override
